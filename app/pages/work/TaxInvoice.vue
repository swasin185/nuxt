<template>
  <UCard>
    <UTable ref='inv' :data="invoices" :columns="columns" @select="onSelectInv" />
    <hr />
    <UTable ref='invitem' :data="invoice.items" :columns="itemColumns" @select="onSelectItem" />
    <template #footer>{{ invoices.length }} records ราคารวม VAT?
...
const columns: TableColumn<Invoice>[] = [
  ...
  },
  {
    ...
    header: 'Customer',
    cell: ({ row }) => { return row.getValue('customer') }
  },
  {
    accessorKey: 'incVAT',
    header: 'incVAT'
